...
**Status:** Akseptert
**Dato:** 2026-02-05
**Oppdatert:** 2026-02-09 (Phase 2: referanse-ekstraksjon, reguleringsversjon, kryssreferanser, EU-dommer, datakvalitet, hent_avgjoerelse, FTS+vektorsøk, seksjonsfiks)
...
### Synkresultater (2026-02-09, full ekstraksjon)

| Metrikk | Verdi |
|---------|-------|
| Saker prosessert | 3 699 (alle med PDF-tekst) |
| Lovhenvisninger | 7 387 (3 042 unike saker) |
| Sakskryssreferanser | 6 605 (2 437 unike saker) |
| EU-referanser | 1 874 (1 006 unike saker) |
| Unike EU-saker | 211 |
| Reguleringsversjon old | 3 348 (45.3%) |
| Reguleringsversjon new | 4 039 (54.7%) |

Årsfilter (2017+) fjernet 2026-02-09. `detect_regulation_version()` klassifiserer gammel/ny forskrift korrekt for alle årganger: 0 tilfeller av `new` på pre-2016, 0 selv-referanser, 367 dangling cross-refs (forventet — refererte saker uten PDF).

### Fordeling lovhenvisninger

| Lov | Antall | Saker | lovdata_doc_id |
|-----|--------|-------|----------------|
| klagenemndsforskriften | 4 420 | 2 897 | 100% |
| anskaffelsesforskriften | 1 075 | 656 | 100% |
| anskaffelsesloven | 890 | 635 | 100% |
| forsyningsforskriften | 425 | 167 | 0% (ikke i lovdata-cache) |
| forvaltningsloven | 290 | 203 | 100% |
| offentleglova | 200 | 146 | 100% |
| tvisteloven | 35 | 30 | 0% |
| konsesjonskontraktforskriften | 31 | 17 | 0% (ikke i lovdata-cache) |
| konkurranseloven | 12 | 12 | 100% |
| straffeloven | 4 | 2 | 0% |
| avtaleloven | 4 | 4 | 0% |
| sikkerhetsloven | 1 | 1 | 0% |
...
| Lovreferanser | 7 387 | 3 042 unike saker |
| Sakskryssreferanser | 6 605 | 2 437 unike saker |
| EU-referanser | 1 874 | 1 006 unike saker |
